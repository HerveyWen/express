...
public class SmsDemoUtils {
    ...
    static final String accessKeyId = "LTAIIteOH7oKMPAf";//
    static final String accessKeySecret = "soDDIhOfa93Pug9LuHBeYakOenPvzG";
    ...
    public static SendSmsResponse sendSms(String telephone, String number) throws ClientException {
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("大辉");// 云通信
        //必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_116568299"); // SMS_1000000
        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
        request.setTemplateParam("{\"code\":\"" + number + "\"}");// "{\"name\":\"Tom\", \"code\":\"123\"}"
    ...
    public static QuerySendDetailsResponse querySendDetails(String bizId) throws ClientException {
        ...
        //必填-号码
        request.setPhoneNumber("15502165856");
        //可选-流水号
